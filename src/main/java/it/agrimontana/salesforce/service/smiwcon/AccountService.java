...
public class AccountService {
    ...
    public void checkCompositeResponseForErrors(String jsonResponse) throws Exception {
        ...
        for (Map<String, Object> subResponse : compositeResponses) {
            ...
            // Jackson may deserialize numbers as Integer or Long -> use Number
        ...
        if (!errors.isEmpty()) {
            ...
            // monitoring DB log (doesn't break flow if it fails)
            try {
                ...
                monitoringDAO.insertLog(
                        "ERROR",
                        "SMIWCON",                 // or whatever service name you want
                        getClass().getName(),
